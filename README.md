...
1. Run the following commands in the project's root directory to set up your database and model.
    ...
    - To run ML pipeline that trains classifier and saves it; below an example:
        ...
        ![Model_image](https://github.com/KhaledGamal1991/Disaster-Response-Project/blob/main/Pics/Model_3.PNG)
...
3. Go to http://0.0.0.0:3001/  
    ![Web_image1](https://github.com/KhaledGamal1991/Disaster-Response-Project/blob/main/Pics/Web_4.PNG)
    ![Web_image2](https://github.com/KhaledGamal1991/Disaster-Response-Project/blob/main/Pics/Web_3.PNG)
